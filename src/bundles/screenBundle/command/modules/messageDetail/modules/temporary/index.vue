...
export default {
  ...
  data() {
    return {
      ...
      visible: false,
      videlUrl: '',
      list: [{ title: '任务ID', name: 'E20200610183842p3RLcB' }, { title: '上报人', name: '麒麟街道管理员' }, { title: '所属组织', name: '麒麟街道' },
        { title: '任务标题', name: '暴露垃圾' }, { title: '任务描述', name: '2020年6月10日。秀园路溧水永阳幼儿园门前发现暴露垃圾，现已处理完毕。' }, { title: '任务类型', name: '暴露垃圾' }, { title: '处理前图片', type: 'img', url: 'http://218.94.132.110:880/group1/M00/00/00/wKgBZV7guByAARiLAATLPYbRkDE74.JPEG' }, { title: '处理后图片', type: 'img', url: 'http://218.94.132.110:880/group1/M00/00/00/wKgBZV7guCKAF--qAASbG5R0Ij444.JPEG' }, { title: '视频文件', type: 'video', url: 'http://218.94.132.110:880/group1/M00/00/00/wKgBZV7guC-AbG-UAGKoBhXrbCs695.mp4' }, { title: '音频文件' }]
    }
  },
  methods: {
    showVideo(url) {
