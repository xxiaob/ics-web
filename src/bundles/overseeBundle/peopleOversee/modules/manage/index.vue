<template>
  <el-dialog :title="title" :visible.sync="dialogVisible" width="600px" :close-on-click-modal="false" :append-to-body="true" @close="dialogClose">
    <div class="jc-clearboth">
      ...
      <div style="text-align:center">{{overseeTypeMsg}}</div>
      <div id="tolive"></div>
    </div>
    <el-form ref="form" label-width="100px" :model="form" class="jc-manage-form" size="mini">
      ...
      <el-form-item label="督查结果" prop="superviseType" :rules="rules.SELECT_NOT_NULL">
      ...
      <el-form-item label="备注" prop="superviseDesc" :rules="rules.NOT_NULL">
        <el-input v-model="form.superviseDesc" placeholder="请输入备注" type="textarea"></el-input>
      </el-form-item>
    </el-form>
...
export default {
  ...
  data() {
    return {
      ...
      superviseTypes: ATTEND_OVERSEE_STATUSES.VALUES.slice(1),
      overseeType: 1,
      overseeTypeMsg: ''
    }
  },
