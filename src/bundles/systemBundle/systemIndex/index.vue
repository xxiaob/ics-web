  ...
  <div class="jc-main-container-warp">
    ...
    <el-card class="jc-table-card jc-mt">
      ...
      <el-table :data="list" v-loading="loading" row-key="positionId" class="jc-table" @selection-change="tableSelect">
        ...
        <el-table-column prop="index" label="排序" width="60"></el-table-column>
        <el-table-column prop="positionName" label="系统名称"></el-table-column>
        <el-table-column prop="positionName" label="logo"></el-table-column>
        <el-table-column prop="positionName" label="是否启用"></el-table-column>
        <el-table-column prop="positionName" label="链接"></el-table-column>
        <el-table-column prop="positionName" label="是否新窗口打开"></el-table-column>
