  ...
  */
  constructor(options = {}) {
    ...
    if (this.draggable) {
      ...
      this.marker = new this.map.AMap.LabelMarker({ rank: this.zIndex, zIndex: this.zIndex, position: this.position, icon: { image: getIcon(this.icon), anchor: 'center', size: this.size }, text: { } })
    }
