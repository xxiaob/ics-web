...
export const VoiceSource = {
  ...
  [VOICE_TYPE.GRID_ARRIVE_ABNORMAL]: '/static/voices/grid-abnormal.wav',
  [VOICE_TYPE.GRID_TIME_ABNORMAL]: '/static/voices/grid-abnormal.wav',
  [VOICE_TYPE.GRID_USER_ABNORMAL]: '/static/voices/grid-abnormal.wav',
